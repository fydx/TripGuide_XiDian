...
public class Welcome extends Activity {
	...
	private void db_init() {
		...
		String intro[] = {
				...
				"首先中间的字度“chai”，一声哦。它在东大街的东侧，是东大街与解放路的交汇处，距离骡马市很近。"
						...
						+ "相信焕然一新的大差市会让你有别样的体验。",
				"民乐园位于火车站附近，火车等的很无奈？下了火车想转转？民乐园是你的好选择。民乐园商圈位于解放路，火车"
						+ "站南侧。说起民乐园五路口，老西安总有中特别的情结。没错，这里是西安最老的商圈，西安人人皆知的民生百货，图书大厦都在这里。当然最近又有了万达，新玛特，民生新乐汇的加入，这里就是购物狂的终极目的地。",
	...
	private void db_my_init() {
		...
		route route = new route(dateString, pos_xString, pos_yString,
				nameString);
